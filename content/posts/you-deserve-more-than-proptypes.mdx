...
of our meetings change? Yes. And we want it to. Also,&nbsp;[we&nbsp;avoid introducing new names][new-names]\
(e.g.`<MeetingInfo author={meeting.organizer} />`).

[new-names]: https://www.swyx.io/writing/how-to-name-things/#not-naming-things-aug-2019-edit
