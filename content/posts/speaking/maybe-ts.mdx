...
spoiler: Null. Monads. TypeScript. We go through problems with hard Option types and provide a fp-ts implementation of soft one. A Billion Dollar Talk? Maybe.
