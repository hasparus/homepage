...
We validate these emails once, and if they're all valid, we save them.
Few steps further in the form, we send our activation links.
Few days later, we get a new requirement -- the user should be able to edit the data at
