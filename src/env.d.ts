...
declare module "*.svg" {
  const content: { src: string; width: number; height: number; format: "svg" };
...
// -----------------------------------------------------
// Code below is stolen from vite/client.d.ts
// - removed .svg declaration in favor of the one above
// -----------------------------------------------------
