...
Obviously, in the code above I started with two variants, and only then needed a
tertiary. I can acknowledge that this is getting to the point where I should use
