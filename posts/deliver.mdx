...
![Performance optimized code can be confusing and complicated. Code written to unrealistic deadlines is usually bad, but you only get to have code if your business is still running.](/content/deliver/tradeoffs-tweets.png)
