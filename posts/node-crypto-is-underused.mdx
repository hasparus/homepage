...
Easy, right? Watch out for this private key.
...
Both RSA and Ed25519 can be used to sign and verify messages.
...
Ed25519 is just a digital signature scheme, so you can't use it for encryption.

If you change `"rsa"` to `"ed25519"` in the [sandbox][codesandbox], one of the
tests will fail with a friendly message:
