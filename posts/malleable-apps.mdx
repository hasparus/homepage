...
In my day job, I work a lot on design systems and user interfaces. I've been
always interested in design and user experience. Recent advances in AI, which
...
We tend to come up with that we have previously explored in the past. It's fine,
...
to be oblivious, repeat the mistakes, and miss the good things.

<div class="flex justify-center">
  <Image
    width={220}
    aspectRatio={0.4585300067}
    src="/content/malleable-apps/i-made-this.webp"
...
I'm not talking about Excel and Notion. Yes, those are nice. I like them.
Pretty&nbsp;excited about Microsoft Loop too.
