...
I'm showing what TypeScript gives you to solve these problems and improve your
...
What do I expect? At least `onClick`, `onFocus`, `disabled`, `className`, and `style`.
...
given a `href` prop and renders a `<button>` otherwise.
...
change? Yes. And we want it to. Also,&nbsp;[we&nbsp;avoid introducing new
names][new-names]\
