...
Whereas in reality, with a finite focus to spend, balancing between 3 qualities
is like picking a point on a sphere octant.
...
In many job ads and company culture docs you'll see a sentence like "we
prioritize speed and quick iteration with a focus on quality and excellence". I
don't disagree that we should strive for balance, but I feel that people often
discount how many different balances are there. All of the |ℝ| balances are
