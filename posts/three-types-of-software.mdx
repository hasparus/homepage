...
Try clicking a point on the octant, then stop hovering, and click the same point
...
Alternatively, pick one of [two YouTubers](https://youtu.be/2Z4fZtSKlcE?t=580).
